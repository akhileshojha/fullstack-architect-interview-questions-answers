...
39. **Practical Question: How to send data from a child to a parent using callback functions?**
...
43. **What are the different design patterns used in React?**

44. **What are the differences between the context API and Redux?**

45. **What are prop types in React? How do you apply validation on props in React?**
...
51. **When should you use `useState` and `useReducer`?**
...
55. **What are the lifecycle methods in Redux?**

56. **What is the use of the store in Redux?**

57. **What is the `useCallback` hook? How do you implement it?**

58. **What is `React.memo` and `useMemo`? Please explain them.**

59. **What is state management in React? Why use a state management library?**

60. **Why do we use React over Angular? What are the advantages and disadvantages of these JavaScript frameworks?**
...
56. **What is the use of store in Redux?**
...
57. **What is `useCallback` hook? How to implement it?**
...
58. **What is `React.memo` and `useMemo`? Please explain it.**
    - **Answer:**
...
60. **Why use React over Angular? What are the advantages and disadvantages of these JavaScript frameworks?**
    - **Answer:**
      - **Advantages of React:**
